# Don't Remove Credit Tg - @Shankar_Kola
# Subscribe YouTube Channel For Amazing Bot https://youtube.com/@achievers_base
...
async def clone_menu(client, message):
    ...
    try:
        ...
        await msg.edit_text(f"⚠️ <b>Bot Error:</b>\n\n<code>{e}</code>\n\n**Kindly forward this message to @Time2ChillBot to get assistance.**")
